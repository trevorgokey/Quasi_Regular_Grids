!=============================================================================80
!                       2D Henon-Heiles Grid Generation
!==============================================================================!
!       Discussion:
!Generate gridpoints (Particles) distributed via the 2D Henon-Helies Potential
!This grid is 'optimized' using a quasi-Lennard Jones Potential 
!Gridpoints have a quasi-regular distribution locally
!Gridpoints are constricted using an energy cutoff contour (E_cut)
!Force minimization, accepting trial moves if they decrease the energy.
!Compute the lower moments of the generated distribution to test accuracy
...
!lambda         ==>HH Potential Parameter (Hamilton, Light 1986 for values) 
!==============================================================================!
implicit none 
