#=============================================================================80
#                 D-dimensional Morse Quasi-Reglar Grid Generation
#==============================================================================!
#Generate gridpoints distributed according to the Morse Potential
#This Quasi-Regular grid is optimized using a quasi-Lennard Jones Pair-Potential
#Forced minimization, accept any trial moves that reduces the system's energy
#Computes low-level moments to check accuracy
#See the publication for further details:
#J. Chem. Phys. 151, 241105 (2019); https://doi.org/10.1063/1.5134677
#Check the Github page for codes
#https://github.com/swflynn/Quasi_Regular_Grids
#==============================================================================!
#       Modified:
#   10 January 2019
#       Author:
#   Shane Flynn
#==============================================================================!
#Attempting to make a python implementation...
...
#omega          ==>(d) parameters for Morse potential
...
#==============================================================================
#quasi-Lennard Jones pairwise potential
#==============================================================================
...
#xmin           ==>(d) minimum of normalization box
#xmax           ==>(d) maximum of normalization box
#Moment         ==>(0:9) Low Moments for the distribution
#==============================================================================
#integer::N_MC,i,j
#double precision::r(d),xmin(d),xmax(d),Moment(0:9),dummy
#Moment=0d0
...
#alpha0         ==>Scaling Parameter for Gaussian Widths
#==============================================================================
#implicit none
#integer::N_MC,N_MC_moments,N_reg,MMC_freq,accept,counter,i,j,k,plt_count
#double precision::Delta_E,deltae1,mv_cutoff,time1,time2,Moment(0:9),alpha0,r2
#double precision,allocatable,dimension(:)::x0,s,U_move,xmin,xmax,alpha
...
#  endif
#enddo
#open(unit=11,file='coor_ini.dat')
#do i=1,Npoints
#  write(11,*) x(:,i)
#enddo
#close(11)
...
#deltae1=0
#plt_count=0
#open(unit=12,file='mv_cut.dat')
#open(unit=13,file='delE.dat')
#do i=1,N_MC
#==============================================================================
...
#    write(12,*) plt_count, mv_cutoff
#    write(13,*) plt_count, Deltae1
#    deltae1=0
#  endif
#enddo
#close(12)
...
#==============================================================================
#do i=1,Npoints
#  alpha(i)=1d20                                   !large distance (initialize)
#  do j=1,Npoints
#    if(j.ne.i) then
