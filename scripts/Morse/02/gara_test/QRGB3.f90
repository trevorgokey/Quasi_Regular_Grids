...
!==============================================================================!
!       Discussion:
!Testing Garaschuk paper directly, use uniform grid (Vlad made grid in exact
!directory, 482 basis functions)
!use alpha=alpha0 (set all widths to be the same constant)
!choose alpha0 to give the same RCN as inthe paper 6.4E-8, (alpha=2.56)
!dont need to normalize P
!==============================================================================!
!       Modified:
!   13 May 2019
!       Author:
...
double precision::E_cut,integral_P,Del_par
!==============================================================================!
contains
!==============================================================================!
function P_x(x_i)
...
integer*8::skip
double precision::time1,time2,aij,r2,alpha0,RCN
...
!set equal to 1 (don't normalize) using uniform grid
!==============================================================================!
!call normalize_P(N_Px)
integral_P=1d0
!==============================================================================!
!                          Generate Alpha Scaling 
!using a uniform grid, just set alpha(i) = constant
!==============================================================================!
alpha=alpha0
!open(unit=17,file='alphas.dat')
!do i=1,NG
!    alpha(i)=alpha0*(E_cut-P_x(x(:,i))+Del_par)
...
!==============================================================================!
!                           Overlap Matrix (S)
!changed the overlap matrix to be normalized, (different prefactor)
!==============================================================================!
do i=1,NG
    do j=i,NG
...
do counter=1,Nsobol/data_freq
   do i=1,NG
      ...
      enddo
   enddo
!   write(*,*) Vmat(1,1)/((counter*data_freq))
!   write(*,*) Vmat(1,2)/((counter*data_freq))
!==============================================================================!
...
write(90,*) 'integral of P(x)==>', integral_p
write(90,*) 'Ecut ==>', E_cut
