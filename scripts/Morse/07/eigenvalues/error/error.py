...
#'Theory' values are computed seperately and sorted smallest to largest
#Error is taken as the deviation from theory value (absolute error)
#==============================================================================#
#       Modified:
#   7 May 2019
#       Author:
...
for i in range(0,num_iter):
    for j in range(0,num_eig_val):
        errors.append(abs(df_eigen[j][i] - df_theory[0][j]))
#==============================================================================!
...
df_theory.to_csv('theory.dat',sep='\t',index=False)
