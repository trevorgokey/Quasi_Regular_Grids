...
!Code was written before re-writing the equaitons in terms of normalized gaussians
!this code was not working for 3D case
!==============================================================================!
!       Modified:
!   15 May 2019
!       Author:
...
do i=1,NG
  do j=i,NG
     ...
     do l1=1,GH_order
        ...
        enddo
     enddo
    Vij=Vij/sqrt(alpha(i)+alpha(j))         !Testing Jacobian
