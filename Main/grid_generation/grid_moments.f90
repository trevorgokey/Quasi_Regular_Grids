!=============================================================================80
!                     Grid Generation (Model Potentials)
!==============================================================================!
!Generate gridpoints for sampling model potential functions
!Pseudo-Random, Quasi-Random (Sobol), Quasi-Regular grids available.
!Morse and Henon-Heiles Potentials available
...
!==============================================================================!
!                                 TO DO LIST:
!Change q-LJ from 12-6 to m-n
!Check to make sure the different potentials work
!add in different grids
!==============================================================================!
module qlj_mod
implicit none
!==============================================================================!
...
!Henon-Heiles (Hard-Coded 2-Dimensional)
!Morse (2D and 3D Tested)
!V              ==>evaluate V(x,y)
!x              ==>(d) ith particles coordinate x^i_1,..,x^i_d
!lambda         ==>Parameter for the Henon-Heiles Potential
!D_morse        ==>Parameter for the Morse Potential
!omega          ==>(3) Parameter for the Morse Potential
!==============================================================================!
implicit none
...
if(potential=='henon' .or. potential=='HENON') then
  V=0.5*(x(1)**2+x(2)**2)+lambda*(x(1)**2*x(2)-x(2)**3/3.)
else if(potential=='morse'.or.potential=='MORSE') then
  V=D_morse*sum((exp(-omega(:)*x(:))-1.)**2)
else
  write(*,*) 'cannot identify the potential'
  write(*,*) 'check the V(x) function'
  STOP
endif
end function V
!==============================================================================!
