!=============================================================================80
!                       Uniform Sobol Distribution
!==============================================================================!
!       Discussion:
!Generate a uniform sobol distribution (Note: not using BSM here)
!Hard-coded to transform domain from [0,1] to [min,max]==> min+x*(max-min)
...
!==============================================================================!
!Return a Uniformly distributed Sobol Sequence over [min,,max]
!==============================================================================!
subroutine sobol_stdnormal(d, skip, x_stdnormal)
    ...
    x_stdnormal=i8_sobol(int(d,8),skip)                !see sobol.f90 for syntax
!transfrom from [0,1] to [-4,4]
    x_stdnormal=-4+x_stdnormal*(4+4)
